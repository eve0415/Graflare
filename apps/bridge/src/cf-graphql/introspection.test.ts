            ...
            fields: [
              {
                ...
                type: {
                  ...
                  ofType: {
                    name: null,
                    kind: 'LIST',
                    ofType: { name: null, kind: 'NON_NULL', ofType: { name: 'AccountWorkersInvocationsAdaptive', kind: 'OBJECT' } },
                  },
                },
              },
              {
              ...
              },
              {
                ...
                type: {
                  name: null,
                  kind: 'NON_NULL',
                  ofType: { name: null, kind: 'LIST', ofType: { name: null, kind: 'NON_NULL', ofType: { name: 'OldType', kind: 'OBJECT' } } },
                },
              },
            ],
          },
    ...
    mockFetch({
      AccountD1AnalyticsAdaptiveGroups: {
        data: {
          ...
          dimensions: {
            fields: [{ name: 'date' }, { name: 'databaseId' }],
          },
          sum: {
            fields: [{ name: 'readQueries' }, { name: 'writeQueries' }],
          },
          avg: null,
          max: null,
          quantiles: null,
