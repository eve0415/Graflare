...
export const schemaCache = sqliteTable(
  ...
  table => [uniqueIndex('schema_cache_pk').on(table.nodeName, table.scope)],
);
...
export const discoveryCache = sqliteTable(
  ...
  table => [uniqueIndex('discovery_cache_pk').on(table.nodeName, table.scope)],
);
...
export const metrics = sqliteTable(
  ...
  table => [
    uniqueIndex('metrics_pk').on(table.ts, table.dataset, table.scope, table.scopeId, table.resource, table.metricName, table.dimsHash),
...
export const syncState = sqliteTable(
  ...
  table => [uniqueIndex('sync_state_pk').on(table.dataset, table.scope, table.scopeId)],
);
...
export const datasetStatus = sqliteTable(
  ...
  table => [uniqueIndex('dataset_status_pk').on(table.dataset, table.scope, table.scopeId)],
);
