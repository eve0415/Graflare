...
import { Tooltip, TooltipContent, TooltipTrigger } from '@graflare/ui/components/tooltip';
import { useIsMobile } from '@graflare/ui/hooks/use-mobile';
...
function SidebarMenuSkeleton({
  ...
  return (
    <div data-slot='sidebar-menu-skeleton' data-sidebar='menu-skeleton' className={cn('flex h-8 items-center gap-2 rounded-xl px-2', className)} {...props}>
