...
import { toggleVariants } from '@graflare/ui/components/toggle';
...
function ToggleGroup({
  ...
  // `CSSProperties` intentionally dropped its index signature, so a CSS custom property needs an
  // explicit type that admits `--*` keys (csstype's sanctioned alternative to a cast).
